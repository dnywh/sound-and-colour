...
// let animationMiddle = [];
// let animationOut = [];
let ballSprites = ['img/ball/spritesheet-in.jpg', 'img/ball/spritesheet-middle.jpg', 'img/ball/spritesheet-out.jpg']

let playState = "off"

function preload() {
  ballSpriteSheetIn = loadImage('img/ball/spritesheet-in.jpg');
  ballSpriteSheetMiddle = loadImage('img/ball/spritesheet-middle.jpg');
  ballSpriteSheetOut = loadImage('img/ball/spritesheet-out.jpg');
}
...
function setup() {
  ...
  ball = new Sprite(ballSpriteSheetIn, ballSpriteSheetMiddle, ballSpriteSheetOut, 0, 0, 300, 0.1);
